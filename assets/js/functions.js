...
function popupUpdateBrowser () {
    ...
    popupBrowser += '<button class="browser-popup-close-btn" title="close"><i class="ri-close-line"></i></button>';
    popupBrowser += '<span class="browser-popup-caution-icon"><i class="ri-error-warning-line"></i></span><h2 class="browser-popup-tit"><b>브라우저 업데이트</b> 안내</h2><p class="browser-popup-txt">현재 사용중인 브라우저는 곧 지원이 중단됩니다. <br>원활한 서비스를 제공받기 위해<br><b>보안과 속도가 강화된 브라우저로 업그레이드</b> 하시기 바랍니다.</p>';
    popupBrowser += '</div>';
...
function smoothScroll(){
	if (window.__DPD_USE_LENIS_SCROLL__ !== false) return;
...
function smoothScroll_destory (event) {
	...
	$("html").removeClass("smooth-srolling");
}
