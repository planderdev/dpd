...
insert into public.company_history ("id", "enabled", "year", "month", "text", "sort_order") values
  ...
  ('history-2024-11-2', true, '2024', '11', '통신판매업 등록', 6),
